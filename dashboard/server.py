...
class DashboardServer:
    ...
    async def _trading_stats(self, request):
        ...
        return web.json_response(trader.get_stats())
    ...
    async def _trading_trades(self, request):
        ...
        trades = trader.get_trades(limit=limit, status=status_filter)
    ...
    async def _channels_add(self, request):
        ...
        fmt_id = db_add_channel_format(channel_id, channel_name, template, default_side)
